...
- Structure du code
  ...
  - ![Reflexion sur la structure du projet](Medias/LogBook/Reflexion.png)
...
- Création des déplacement des individus
  - Vitesse
  - Direction
  - ![Reflexion sur les mouvements des individus](Medias/LogBook/Movement.png)
...
- Création des bus
  ...
  - Idée 1:
    ...
    - ![Première idée de structure des bus Intérieur](Medias/LogBook/Bus1.png)
  - Idée 2:
    ...
    - ![Deuxième idée de structure des bus Exterieur](Medias/LogBook/Bus2.png)
  - Idée 3:
    ...
    - ![Troisième idée de structure des bus Exterieur](Medias/LogBook/Bus3.png)
- Ajout d'une légende
...
- Vehicules
  ...
  - Reflection sur les bus. L'idée actuelle est bonne mais risque de restraindre la simulation en terme de planning.
    ...
    - ![Idée final sur la structure des bus](Medias/LogBook/Bus4.png)
